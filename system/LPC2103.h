...
#define TIMER0_IR		T0IR		
#define TIMER0_TCR		T0TCR		
#define TIMER0_TC		T0TC		
#define TIMER0_PR		T0PR		
#define TIMER0_PC		T0PC		
#define TIMER0_MCR		T0MCR		
#define TIMER0_MR0		T0MR0		
#define TIMER0_MR1		T0MR1		
#define TIMER0_MR2		T0MR2		
#define TIMER0_MR3		T0MR3		
#define TIMER0_CCR		T0CCR		
#define TIMER0_CR0		T0CR0		
#define TIMER0_CR1		T0CR1		
#define TIMER0_CR2		T0CR2		
#define TIMER0_EMR		T0EMR		
#define TIMER0_CTCR		T0CTCR		
#define TIMER0_PWMCON	T0PWMCON	
...
#define TIMER1_MR1		T1MR1		
#define TIMER1_MR2		T1MR2		
#define TIMER1_MR3		T1MR3		
#define TIMER1_CCR		T1CCR		
#define TIMER1_CR0		T1CR0		
#define TIMER1_CR1		T1CR1		
#define TIMER1_CR2		T1CR2		
#define TIMER1_EMR		T1EMR		
#define TIMER1_CTCR		T1CTCR		
#define TIMER1_PWMCON	T1PWMCON	
...
#define TIMER2_CR0		T2CR0		
#define TIMER2_CR1		T2CR1		
#define TIMER2_CR2		T2CR2		
...
#define TIMER3_CR0		T3CR0		
#define TIMER3_CR1		T3CR1		
#define TIMER3_CR2		T3CR2		
